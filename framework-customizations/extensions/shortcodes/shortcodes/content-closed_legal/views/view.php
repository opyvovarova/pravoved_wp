...
?>
<div class="box__price closed_legal">
    <div class="container">
    <?php foreach($atts['top_text'] as $top){ ?>
        <div class="closed_legal-text">
        <p><?= $top['text'] ?>
        </div>
        <?php }; ?>
        ...
        <?php foreach($atts['price_box'] as $price) {?>
            ...
            <div class="flex-table row item-1" role="rowgroup">
                <div class="flex-row" role="cell">
                    ...
                    <div class="box__price-day"><?= $price['how'] ?>
                    </div>
                </div>
                ...
                <div class="flex-row background__order item-3" role="cell">
                    <div class="box__price-order">
                        ...
                        <button  class="order__service" rel="popup1">Заказaть услугу</button>
